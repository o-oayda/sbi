...
python -m dipolesbi.tools.posterior_cli fiducial_50k_NPE/20251024_204611_SEED0_NPE fiducial_50k/20251011_155810_SEED0_NLE/ --corner corner_test.pdf --corner-columns log10_n_initial_samples w1_extra_error observer_speed dipole_longitude dipole_latitude --legend "CatSIM fiducial model posterior (NPE)" "CatSIM fiducial model posterior (NLE)" --corner-no-credible-lines --corner-stack-credible-titles
